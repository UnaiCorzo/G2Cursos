                ...
                <div class="col-lg-7 col-12">
                    <div class="row px-3">
                        ...
                        <div class="col-6 d-flex justify-content-start align-items-end docente_cursos p-0">
                            <p class="m-0 items creador_curso fw-bold">
                        ...
                        <div class="col-12 d-flex justify-content-center mt-5">
                            @if ($subscribed)
                                <a href="{{ route('unsubscribe', ['id' => $id, 'language' => app()->getLocale()]) }} }}"
                                    ...
                                    {{ __('Quitar') }}</a>
                                @if ($rated == false)
                                    <a href="" class="btn text-uppercase mx-2 py-2 items boton_sesion"
                                        style="font-weight: bold; text-shadow: #0B132B 1px 1px 1px; font-size: .9rem;"
                                        data-bs-toggle="modal" data-bs-target="#valorar_curso">
                                        {{ __('Valorar') }}</a>
                                @endif
                                ...
                                @endif
                            @else
                                <a href="{{ route('subscribe', ['id' => $id, 'language' => app()->getLocale()]) }}"
                                    class="btn text-uppercase mx-2 py-2 items boton_sesion"
                                    style="font-weight: bold; text-shadow: #0B132B 1px 1px 1px; font-size: .9rem;">
                                    {{ __('Añadir') }}</a>
                            @endif
