...
@section('user_content')
    ...
    <section class="page-section seccion_perfil mt-3" id="perfil">
        <div class="container mt-0">
            ...
            <form class="form-control" id="modificar_perfil" method="post"
                action="{{ route('profile_modify', [app()->getLocale(), auth()->user()->id]) }}">
                {{ csrf_field() }}
                <div class="col-12 p-3 d-flex justify-content-center align-items-center rounded bg-light">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 form-group mb-1 d-flex justify-content-between align-items-start gap-2"
                            id="nombre_perfil">
                            <i class="fas fa-user iconos_perfil"></i>
                            <div class="campos_perfil">
                                <input class="form-control p-2 items" type="text" name="name"
                                    placeholder="{{ __('Nombre') }}" value="{{ auth()->user()->name }}" disabled />
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 form-group mb-1 d-flex justify-content-between align-items-start gap-2"
                            ...
                            <i class="fas fa-user iconos_perfil"></i>
                            <div class="campos_perfil">
                                <input class="form-control p-2 items" type="text" name="surnames"
                                    placeholder="{{ __('Apellidos') }}" value="{{ auth()->user()->surnames }}"
                                    disabled />
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 form-group mb-1 d-flex justify-content-between align-items-start gap-2"
                            ...
                            <div class="campos_perfil">
                                <input class="form-control p-2 items" type="text" name="email" placeholder="Email"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 form-group mb-1 d-flex justify-content-end align-items-start gap-2"
                            id="dni_pefil">
                            <button
                                class="btn py-2 items boton_sesion d-flex justify-content-between align-items-center gap-3"
                                id="editButton3" type="button" data-bs-toggle="modal" data-bs-target="#modal_password">
                        ...
                        <div class="col-12 d-flex justify-content-center align-items-center text-center mt-3">
                            <button class="btn submit_sesion boton_sesion py-2 items text-uppercase" id="modifyButton"
                        ...
                        <div class="col-12 mt-3 d-flex justify-content-end align-items-center">
                            <a href="" class="registrarse_sesion items ms-5" data-bs-toggle="modal"
                                data-bs-target="#modal_eliminar_usuario">{{ __('Borrar cuenta') }}</a>
                        </div>
                    </div>
                </div>
            </form>
            ...
            <div class="modal-content">
                <section class="fondo_formulario_sesion">
                    <div class="container contenedor_modal contenedor_sesion">
                        <form class="form-control formulario_sesion" id="modificar_password" method="post"
                            name="change_password" action="{{ route('reset_password', app()->getLocale()) }}">
                            {{ csrf_field() }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div
                                            ...
                                            <div class="campos_registro">
                                                <input class="form-control p-2 campos_sesion" id="password_1"
                                                    type="password" placeholder="{{ __('Contraseña actual') }}"
                                                    name="password1" />
                                                @error('message')
                                                    <label class="error" id="error_password"
                                                        for="password_1">{{ $message }}</label>
                                                @enderror
                                            </div>
                                        </div>
                                        <div
                                            ...
                                            <i class="fas fa-lock mb-2 iconos_sesion icono_formulario"></i>
                                            <div class="campos_registro">
                                                <input class="form-control p-2 campos_sesion" id="password_2"
                                                    type="password" placeholder="{{ __('Nueva contraseña') }}"
                                                    name="password2" />
                                            </div>
                                        </div>
                                        <div
                                            ...
                                            <i class="fas fa-lock mb-2 iconos_sesion icono_formulario"></i>
                                            <div class="campos_registro">
                                                <input class="form-control p-2 campos_sesion" id="password_3"
                                                    type="password" placeholder="{{ __('Nueva contraseña') }}"
                                                    name="password3" />
                                            </div>
                                        </div>
                                        <div
                                            class="col-12 d-flex justify-content-center align-items-center text-center mt-2 mb-2">
                                            <button class="btn submit_sesion boton_sesion py-2 items text-uppercase"
                                                id="modifyPasswordButton" type="submit">
                                                {{ __('Modificar') }}
                                            </button>
                                        </div>
                                    </div>
            ...
            <div class="modal-content bg-dark">
                <div class="modal-header align-items-start">
                    <p class="modal-title text-danger text-center h4 items">
                        {{ __('¿Seguro que quieres borrar este perfil?') }}</p>
                    <button type="button" class="btn-close close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-footer">
                    <form action="{{ route('delete_profile', [app()->getLocale(), auth()->user()->id]) }}"
                        method="post" class="col-12 d-flex justify-content-center gap-3">
                        {{ csrf_field() }}
