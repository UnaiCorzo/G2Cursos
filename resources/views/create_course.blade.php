...
@section('user_content')
    ...
    <section class="page-section seccion_cursos mt-3" id="cursos">
        <div class="container mt-0">
            ...
            <form action="{{ route('course-store', app()->getLocale()) }}" method="post" class="row p-3"
                id="crear_curso" enctype="multipart/form-data">
                {{ csrf_field() }}
