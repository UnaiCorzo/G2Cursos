...
@section('user_content')
    ...
    <section class="page-section seccion_cursos mt-3" id="cursos">
        <div class="container mt-0">
            ...
            <form action="{{ route('course-store', app()->getLocale()) }}" method="post" class="row p-3" id="crear_curso" enctype="multipart/form-data">
            {{ csrf_field() }}
                    ...
                    <div class="row mb-5 p-3">
                        <div class="col-lg-6 col-12 form-group px-2 px-lg-5 px-md-5 mb-2 d-flex justify-content-between align-items-start" id="nombre">
                            ...
                            <div class="campos_registro">
                                <input class="form-control p-2 campos_sesion campos_crear" type="text" id="name" name="name" placeholder="{{ __('Título curso') }}"/>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-12 form-group px-2 px-lg-5 px-md-5 mb-2 d-flex justify-content-between align-items-start" id="nombre">
                            ...
                            <div class="campos_registro">
                                <input class="form-control p-2 campos_sesion campos_crear" type="number" id="price" step="0.01" name="price" placeholder="{{ __('Precio curso') }}"/>
                            </div>
                        </div>
                        <div class="col-lg-6 col-12 form-group px-2 px-lg-5 px-md-5 mb-2 d-flex justify-content-between align-items-start" id="nombre">
                            <i class="fas fa-sign mb-2 mt-2 iconos_sesion"></i>
                            <div class="campos_registro_area">
                                <textarea class="form-control p-2 campos_sesion campos_crear" rows="5" id="description" name="description" placeholder="{{ __('Descripción curso') }}" style="resize: none;"></textarea>
                            </div>
                        </div>
                        <div class="col-lg-6 col-12 form-group px-2 px-lg-5 px-md-5 mb-2 d-flex flex-column justify-content-start align-items-start gap-3" id="nombre">
                            ...
                            <div class="campos_registro campos_hidden">
