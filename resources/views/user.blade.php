                    ...
                    <div class="portfolio-item" id="card2" data-bs-toggle="modal" data-bs-target="#modal_sesion">
                        ...
                        <div class="portfolio-caption">
                            ...
                            <div class="row m-0 p-0">
                                ...
                                <div class="col-12 m-0 p-0 mt-2 categorias">
                                    <span class="badge badge-pill text-white items categorias_cursos bg-warning">CSS</span>
                                    <span class="badge badge-pill text-white items categorias_cursos bg-secondary">HTML</span>
                                    <span class="badge badge-pill text-white items categorias_cursos bg-info">Frontend</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="portfolio-item" id="card3" data-bs-toggle="modal" data-bs-target="#modal_sesion">
                        ...
                        <div class="portfolio-caption">
                            ...
                            <div class="row m-0 p-0">
                                ...
                                <div class="col-12 m-0 p-0 mt-2 categorias">
                                    <span class="badge badge-pill text-white items categorias_cursos bg-dark">Despliegue</span>
                                    <span class="badge badge-pill text-white items categorias_cursos bg-danger">Linux</span>
                                    <span class="badge badge-pill text-white items categorias_cursos bg-primary">Windows</span>
                                </div>
                            </div>
                        </div>
                    </div>
